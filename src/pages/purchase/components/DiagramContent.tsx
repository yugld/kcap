        ...
        <section className="diagramContent">
            <div className="container mx-auto px-5 lg:px-0 lg:w-4/5 3xl:w-2/3 pt-10 pb-16 lg:py-16">
                <div className="flex flex-col lg:flex-row items-center lg:justify-between space-y-12 lg:gap-16">
                    <div className="text space-y-4 w-full lg:w-1/2 ">
                        <h2 className="text-xl uppercase">Закупаем сырье</h2>
                        ...
                        <p className="">
                            ...
                            результате производства деталей, механизмов, а также
                            вышедших из строя технических и бытовых изделий.
                        </p>
                        <div className="">
                            <p>
                                По вопросам поставки лома обращаться к менеджеру
                                по закупу <br></br>Аблай Атентай:
                            </p>
                            <ul>
                                <li>
                                    тел.{" "}
